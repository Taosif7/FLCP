...
/// Utilities for handling the pubspec file and generating release file names.
class PubspecUtils {
  /// Returns the pubspec.yaml file if found, checking the current and parent directories.
  ...
  /// Generates a release file name from [pubspec] with optional [additionalSuffixes],
  /// and whether to [includeDate]. An optional [date] can be provided.
